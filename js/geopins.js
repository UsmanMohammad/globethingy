function loadCountryGeoData( latlonData ){
    //	-----------------------------------------------------------------------------
...
function loadAirportGeoData( airportlatlonData ){
    //	-----------------------------------------------------------------------------
    //	Load the world geo data json, per country	
	...
	//	iterate through each set of country pins
	for ( var i in airportlatlonData.airports ) {										
		var airport = airportlatlonData.airports[i];	
		...
		//	save out country name and code info
		airport.airportCode = i;		

		//	take the lat lon from the data and convert this to 3d globe space
        var lon = airport.lon - 90;
        var lat = airport.lat;
